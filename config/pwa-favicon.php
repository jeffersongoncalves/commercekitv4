...
// TODO: resources/favicon/icon-512x512.png and icon-512x512-maskable.png are upscaled from android-icon-192x192.png — replace with proper 512px source assets.
...
return [
    ...
    'manifest' => [
        'name' => env('APP_NAME', 'CommerceKit'),
        'short_name' => env('APP_NAME', 'CommerceKit'),
